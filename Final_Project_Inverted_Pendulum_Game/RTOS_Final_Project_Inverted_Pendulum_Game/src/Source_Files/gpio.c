...
//	GPIO_DriveStrengthSet(LED1_port, gpioDriveStrengthStrongAlternateStrong);
	...
	GPIO_PinModeSet(BUTTON_0_port, BUTTON_0_pin, gpioModeInput, BUTTON_0_default);
	GPIO_IntConfig(BUTTON_0_port, BUTTON_0_pin, true, true, true);

	GPIO_PinModeSet(BUTTON_1_port, BUTTON_1_pin, gpioModeInput, BUTTON_1_default);
...
void GPIO_Unified_IRQ(void)
{
  ...
  if (interruptMask & (1 << BUTTON_0_pin)) {
	  ...
	  samplePushButton_0();
//	  button_events |= Button0_Event;
  }

  if (interruptMask & (1 << BUTTON_1_pin)) {

	  samplePushButton_1();
//	  button_events |= Button1_Event;
  }
